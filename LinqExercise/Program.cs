...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var ascOrdered = numbers.OrderBy(x => x);
            foreach (var number in ascOrdered)
            {
                Console.WriteLine(number);
            }
                
            //TODO: Order numbers in descending order and print to the console
            var descOrdered = numbers.OrderByDescending(x => x);
            foreach (var number in descOrdered)
            {
                Console.WriteLine(number);
            }
            ...
            foreach (var number in ascOrdered.Take(4))
            {
                Console.WriteLine(number);
            }
            ...
            employees = employees.Append(new Employee("Briun", "Greene", 37, 2)).ToList();
